...
print(f"\nCaffeine: {len(caffeine)} atoms")
print(f"  Formula: {caffeine.get_chemical_formula()}")
...
write('caffeine.xyz', caffeine)
print("Saved: caffeine.xyz")
...
print("=" * 70)
print("- water.xyz, caffeine.xyz, cu_surface.xyz, cu_with_co.xyz")
